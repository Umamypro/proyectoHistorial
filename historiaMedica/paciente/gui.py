...
class Frame(tk.Frame):
    ...
    def camposPaciente(self):
        ...
        self.btnNuevo.config(width=20, font=('ARIAL',12,'bold'), fg='#74FF00', bg='#158645', cursor='hand2',activebackground='#35BD6F')
        self.btnNuevo.grid(column=0, row=9, padx=10, pady=5)
        
        self.btnGuardar = tk.Button(self, text='Guardar', command=self.guardarPaciente)
        self.btnGuardar.config(width=20, font=('ARIAL',12,'bold'), fg='Blue', bg='#000000', cursor='hand2',activebackground='#5F5F5F')
        ...
        self.btnCancelar.config(width=20, font=('ARIAL',12,'bold'), fg='Red', bg='#B00000', cursor='hand2',activebackground='#35BD6F')
        ...
        self.entryBuscarDni.config(width=30, font=('ARIAL',15))
    ...
    def tablaPaciente(self, where=""):
        ...
        self.btnSalir.config(width = 20,font=('ARIAL',13,'bold'), fg='Red', bg='#8A0000', activebackground='#99F2F0', cursor='hand2')
        self.btnSalir.grid(row=11, column=5, padx=10, pady=5)
