...
class Frame(tk.Frame):
    ...
    def camposPaciente(self):
        ...
        self.btnNuevo.config(width=20, font=('ARIAL',13,'bold'), fg='green', bg='#158645', cursor='hand2',activebackground='#35BD6F')
        self.btnNuevo.grid(column=0, row=9, padx=10, pady=5)
        
        self.btnGuardar = tk.Button(self, text='Guardar', command=self.guardarPaciente)
        self.btnGuardar.config(width=20, font=('ARIAL',13,'bold'), fg='Blue', bg='#000000', cursor='hand2',activebackground='#5F5F5F')
        ...
        self.btnCancelar.config(width=20, font=('ARIAL',13,'bold'), fg='Red', bg='#B00000', cursor='hand2',activebackground='#35BD6F')
        ...
        self.entryBuscarDni.config(width=12, font=('ARIAL',15))
        ...
        self.entryBuscarApellido.config(width=12, font=('ARIAL',15))
        ...
        self.btnBuscarCondicion.config(width=20, font=('ARIAL',15,'bold'), fg='Blue',
        ...
        self.btnLimpiarBuscador.config(width=20, font=('ARIAL',16,'bold'), fg='Blue',
                                bg='#B00000', cursor='hand2', activebackground='#D27C7C')
        ...
        self.btnCalendario.config(width=15, font=('ARIAL',15,'bold'), fg='Blue',
                                bg='#B00000', cursor='hand2', activebackground='#D27C7C')
    ...
    def tablaPaciente(self, where=""):
        ...
        self.tabla.column("#7", anchor=W, width=210)
        self.tabla.column("#8", anchor=W, width=250)
        self.tabla.column("#9", anchor=W, width=95)
        ...
        self.btnEditarPaciente.config(width = 20,font=('ARIAL',13,'bold'), fg='green', bg='#1E0075', activebackground='#9379E0', cursor='hand2')
        ...
        self.btnEliminarPaciente.config(width = 20,font=('ARIAL',13,'bold'), fg='red', bg='#8A0000', activebackground='#D58A8A', cursor='hand2')
        self.btnEliminarPaciente.grid(row=11, column=2, padx=10, pady=5)

        self.btnHistorialPaciente = tk.Button(self, text='Historial Paciente', command=self.historiaMedica)
        self.btnHistorialPaciente.config(width = 20,font=('ARIAL',13,'bold'), fg='Blue', bg='#8A0000', activebackground='#99F2F0', cursor='hand2')
        self.btnHistorialPaciente.grid(row=11, column=1, padx=10, pady=5)

        self.btnSalir = tk.Button(self, text='Salir', command=self.root.destroy)
        self.btnSalir.config(width = 20,font=('ARIAL',13,'bold'), fg='Black', bg='#8A0000', activebackground='#99F2F0', cursor='hand2')
    ...
    def historiaMedica(self):
        ...
        try:
            ...
            self.btnGuardarHistoria = tk.Button(self.topHistoriaMedica, text='Agregar Historial', command=self.topAgregarHistoria)
            self.btnGuardarHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='green', bg='#002771', cursor='hand2', activebackground='#7198E0')
            self.btnGuardarHistoria.grid(row=2, column=0, padx=10, pady=5)

            self.btnEditarHistoria = tk.Button(self.topHistoriaMedica, text='Editar Historial', command=self.topEditarHistorialMedico)
            self.btnEditarHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='Blue', bg='#002771', cursor='hand2', activebackground='#7198E0')
            self.btnEditarHistoria.grid(row=2, column=1, padx=10, pady=5)

            self.btnEliminarHistoria = tk.Button(self.topHistoriaMedica, text='Eliminar Historial', command=self.eliminarHistorialMedico)
            self.btnEliminarHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='Red', bg='#002771', cursor='hand2', activebackground='#7198E0')
            ...
            self.btnSalirHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='Black', bg='#002771', cursor='hand2', activebackground='#7198E0')
    ...
    def topAgregarHistoria(self):
        ...
        #LABELS AGREGAR HISTORIAL MEDICA
        ...
        #ENTRYS AGREGAR HISTORIAL MEDICA
        ...
        #BUTTONS AGREGAR HISTORIAL
        self.btnAgregarHistoria = tk.Button(self.frameFechaHistoria, text='Agregar Historia', command=self.agregarHistorialMedico)
        self.btnAgregarHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='Blue', bg='#000992', cursor='hand2', activebackground='#4E56C6')
        ...
        self.btnSalirAgregarHistoria.config(width=20, font=('ARIAL', 13, 'bold'), fg='Red', bg='#000000', cursor='hand2', activebackground='#4E56C6')
    ...
    def agregarHistorialMedico(self):
        try:
            ...
            mensaje = 'Error al agregar Historial Medica'
            messagebox.showerror(title, mensaje)
    ...
    def eliminarHistorialMedico(self):
        try:
            ...
            mensaje = 'Error al Eliminar Historial Medica'
            messagebox.showerror(title, mensaje)
    ...
    def topEditarHistorialMedico(self):
        try:
            ...
            self.topEditarHistoria.title('EDITAR HISTORIAL MEDICA')
            ...
            self.btnEditarHistoriaMedica = tk.Button(self.frameFechaEditar, text='Editar Historial', command = self.historiaMedicaEditar)
            self.btnEditarHistoriaMedica.config(width=20, font=('ARIAL', 13, 'bold'), fg='Blue', bg='#030058', cursor='hand2', activebackground='#8989DA')
            ...
            self.btnSalirEditarHistoriaMedica.config(width=20, font=('ARIAL', 13, 'bold'), fg='Black', bg='#030058', cursor='hand2', activebackground='#8989DA')
            ...
            mensaje = 'Error Al Editar Historial'
            messagebox.showerror(title, mensaje)
